...
This repository follows structured data engineering and ML best practices.
Please adhere to the guidelines below to maintain consistency.
...
- Each notebook should include:
  ...
  - Input assumptions
  - Output description
- Avoid hard-coded paths where possible
